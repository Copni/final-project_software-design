...
public class InAppNotificationObserver implements AppointmentObserver {
    private final NotificationFactory factory;
    private final NotificationService service;

    public InAppNotificationObserver(NotificationFactory factory, NotificationService service) {
